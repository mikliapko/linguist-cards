...
class ChatGPTApiHelper(ChatGPTApiBase):
    ...
    def ask_for_translation(self, word: str) -> str:
        ...
        user_prompt = (
            ...
            "C - Translation of the original word/phrase into Russian (translate only the word/phrase, "
            "not the example sentence). The translation should match the context shown in the example sentence\n."
            "D - Transcription.\n"
            "E - One synonym\n\n"
